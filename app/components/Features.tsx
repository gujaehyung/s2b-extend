  ...
  const features = [
    {
      ...
      title: "관리일 일괄 연장",
      description: "수천 개의 물품 관리일을 클릭 한 번으로 자동 연장하여 시간을 대폭 절약하세요."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
      ...
      title: "스마트 가격 조정",
      description: "설정한 인상률에 따라 모든 물품 가격을 자동으로 조정하고 100원 단위로 반올림합니다."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
      ...
      title: "실시간 모니터링",
      description: "작업 진행 상황을 실시간으로 확인하고 상세한 로그를 통해 처리 결과를 검토하세요."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
      ...
      title: "안전한 처리",
      description: "중복 처리 방지 및 오류 복구 기능으로 안전하고 신뢰할 수 있는 자동화를 제공합니다."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
      ...
      title: "처리 이력 관리",
      description: "처리된 물품 정보를 자동으로 저장하여 중복 작업을 방지하고 효율성을 극대화합니다."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
      ...
      title: "맞춤형 설정",
      description: "가격 인상률, 처리 범위 등을 자유롭게 설정하여 비즈니스 요구사항에 맞게 조정하세요."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            S2B 업무를 효율적으로 관리할 수 있는 모든 기능을 제공합니다
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              복잡한 S2B 관리 업무를 자동화하고 더 중요한 일에 집중하세요
            </p>
